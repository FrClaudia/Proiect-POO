...
public:
	...
	void serializare()
	{
		ofstream f("C_integer.bin", ios::binary);
		f.write((char*)&nr_valori_integer, sizeof(nr_valori_integer));
		for (int i = 0; i < nr_valori_integer; i++)
		{
			f.write((char*)&valori_integer[i], sizeof(valori_integer[i]));
		}
		f.write((char*)&valoare_implicita_integer, sizeof(valoare_implicita_integer));
		f.write((char*)&dimensiune_integer, sizeof(dimensiune_integer));
		f.close();
	}

	void deserializare()
	{
		ifstream f("C_integer.bin", ios::binary);
		f.read((char*)&nr_valori_integer, sizeof(nr_valori_integer));
		delete[] valori_integer;
		valori_integer = new int[nr_valori_integer];
		for (int i = 0; i < nr_valori_integer; i++)
		{
			f.read((char*)&valori_integer[i], sizeof(valori_integer[i]));
		}
		f.read((char*)&valoare_implicita_integer, sizeof(valoare_implicita_integer));
		f.read((char*)&dimensiune_integer, sizeof(dimensiune_integer));
		f.close();
	}
	...
	//friend ofstream& operator<<(ofstream&, C_integer);
	//friend ifstream& operator>>(ifstream&, C_integer&);
};
...
//ofstream& operator<<(ofstream& out, C_integer i)
//{
//	out << (COLOANA&)i << endl;
//	cout << "Nr valori integer: ";
//	out << i.nr_valori_integer << endl;
...
//	cout << "Valoare implicita integer: ";
//	out << i.valoare_implicita_integer << endl;
//	cout << "Dimensiune integer: ";
//	out << i.dimensiune_integer << endl;
//	return out;
//}

//ifstream& operator>>(ifstream& in, C_integer& i)
//{
//	in >> (COLOANA&)i;
//	cout << "Nr valori integer: ";
//	in >> i.nr_valori_integer;
